...
import src.main.java.config.ConfigReader;
...
public class DatabaseConnectorImpl implements DatabaseConnector {
    ...
    public DatabaseConnectorImpl() throws CAException{
        try
        {
            ...
            String url = "jdbc:mysql://"+reader.getDomain()+":"+reader.getPort()+"/"+reader.getDatabaseName()+"?characterEncoding=UTF-8&useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Europe/Athens&useSSL=false";
